...
/// Implements Contemporary Wellness Minimalism with Energetic Neutrals color scheme.
class AppTheme {
  AppTheme._();

  // Primary color palette - Deep forest green for trust and health association
  static const Color primaryLight = Color(0xFF2E7D32);
  static const Color primaryVariantLight = Color(0xFF1B5E20);
  static const Color onPrimaryLight = Color(0xFFFFFFFF);

  // Secondary color - Professional blue for interactive elements
  static const Color secondaryLight = Color(0xFF1565C0);
  static const Color secondaryVariantLight = Color(0xFF0D47A1);
  static const Color onSecondaryLight = Color(0xFFFFFFFF);

  // Accent color - Energetic orange for progress and CTAs
  ...
  // Border and divider colors - Minimal 1px borders in #E0E0E0
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    // Card theme - Subtle elevation with 2-4dp blur radius
    ...
    // Floating Action Button - Positioned for thumb accessibility
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ElevatedButton.styleFrom(
        ...
        minimumSize: const Size(88, 48), // 48dp minimum for touch targets
    ...
    // Progress indicator theme - Adaptive progress visualization
  ...
  /// Used for numerical data, workout timers, and progress metrics
  ...
  /// Animation duration constants - Essential transitions with 200-300ms durations
